...
public class FormScannerModel {
	...
	public void loadTemplate() {
		...
		if (templateFile != null) {
			try {
				...
				manageTemplateFrame.viewButtonVisible(false);
	...
	public void editTemplate(){
		openTemplate();
		try {
			templateImage = ImageIO.read(fileUtils.chooseImage());
		}catch (Exception e){
			logger.debug("Error load image");
		}
		manageTemplateFrame = new ManageTemplateFrame(this);
	...
	public void createTemplateImageFrame(String fieldsType) {
		...
		case FormScannerConstants.VIEW:
			imageFrame = new ImageFrame(this, templateImage, formTemplate, Mode.VIEW);
			break;
		}
	...
	public void removeField(String groupName, String fieldName) {
		formTemplate.removeByName(groupName, fieldName);
	}
