...
public final class MenuBar extends JMenuBar implements MenuView {
	...
	private JMenuItem editLoadTemplateMenuItem;
	...
	public JMenu getTemplateMenu() {
		...
		editLoadTemplateMenuItem = new MenuItemBuilder(
				FormScannerTranslation
						.getTranslationFor(FormScannerTranslationKeys.EDIT_TEMPLATE),
				orientation)
				.withActionCommand(FormScannerConstants.EDIT_LOAD_TEMPLATE)
				.withActionListener(formScannerController)
				.withMnemonic(
						FormScannerTranslation
								.getMnemonicFor(FormScannerTranslationKeys.EDIT_TEMPLATE_MNEMONIC))
				.withAccelerator(
						KeyStroke.getKeyStroke(
